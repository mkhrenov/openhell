...
BOM_CSV_FILE = "combat-pcb-bom.csv"
PROJECT_NAME = "combat-pcb"
...
class BomRow:
    ...
    def from_kicad_row(cls, row):
        ...
        return cls(reference, value, footprint, description, pn.strip())
...
def main():
    bom = read_kicad_bom(BOM_CSV_FILE)
    ...
    convert_placement(f'fab/{PROJECT_NAME}-top-pos.csv', 'fab/{PROJECT_NAME}-top-pos-jlc.csv', refs)
